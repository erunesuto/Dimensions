...
public class PlayerPlanning : MonoBehaviour
{
    ...
    private bool planningAvailable = false;
    ...
    void Start()
    {
        ...
        playerController = GetComponentInParent<PlayerController>();//accede al script controladorPJ del padre
    }
